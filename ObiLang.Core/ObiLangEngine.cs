...
namespace ObiLang.Core
{
    public class ObiLangEngine
    {
        ...
        public ICacheHandle GetHandleFromObject(string varname,string mname,object[] parms=null)
        {
        ...
        private ICacheHandle AddCache(CacheHandle handle,string mname,object ret,object[] parms)
        {
            ...
            if (typ.BaseType.Equals(typeof(PropertyInfo)))
            {
            ...
            if (typ.BaseType.Equals(typeof(FieldInfo)))
            {
            ...
            if (typ.BaseType.Equals(typeof(MethodInfo)))
            {
            ...
            if (typ.BaseType.Equals(typeof(EventInfo)))
            {
            ...
            string result = "";
                ...
                if (line[0] == '#') continue;
                    ...
                    string catchname = "catch";
                        ...
                        {
                            var cond = new CONDITIONAL(reclines.ToArray(),elsereclines.ToArray(), true, cmd);
